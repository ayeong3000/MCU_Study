...
const U8 seg_pat[10] = { 0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x7d, 0x07, 0x7f, 0x6f };
//Global 변수 설정. 초기화 하기
U8 EINT4_FlAG_BIT = 0;
U8 EINT5_FlAG_BIT = 0;
U8 EINT6_FlAG_BIT = 0;
...
//함수설정(알아보기 쉬운 이름으로)
void Seg4_out(U8 N1, U8 N10, U8 N100, U8 N1000);  //Segment 네자리 정수 출력 함수 정의(생년)
void Seg4_out2(U8 N1, U8 N10, U8 N100, U8 N1000); //Segment 네자리 정수 출력 함수 정의(월일)
...
//세그먼트 디스플레이
void Seg4_out(U8 N1, U8 N10, U8 N100, U8 N1000)    //생일 - 생년 디스플레이
{
    U8 i;
...
void Seg4_out2(U8 N1, U8 N10, U8 N100, U8 N1000)   //생일 - 월일 디스플레이
{

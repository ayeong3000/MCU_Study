...
U8 string7[] = "Please press the numbers 4 to 7: \r";
/*U8 string7[] = "No 4\r";
U8 string8[] = "No 5\r";
U8 string9[] = "No 6\r";
U8 string10[] = "No 7\r";
...
/*void Menu_display_input(void) {
    if (EINT4_FLAG_BIT == 1) {
        pStr = strncat(string6,string7,4);
        while (*pStr != 0) Putch(*pStr);
    }
    if (EINT5_FLAG_BIT == 1) {
        pStr = strncat(string6,string8,4);
        while (*pStr != 0) Putch(*pStr);
    }
    if (EINT6_FLAG_BIT == 1) {
        pStr = strncat(string6,string9,4);
        while (*pStr != 0) Putch(*pStr);
    }
    if (EINT7_FLAG_BIT == 1) {
        pStr = strncat(string6,string10,4);
        while (*pStr != 0) Putch(*pStr);
    }
} */